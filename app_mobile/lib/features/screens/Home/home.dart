              ...
              child: Stack(
                children: [
                  Positioned(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(
                          18.67 * fem, 18.67 * fem, 18.67 * fem, 18.67 * fem),
                      width: 64 * fem,
                      height: 64 * fem,
                      decoration: BoxDecoration(
                        color: const Color(0xfff6f8fe),
                      ...
                      child: SizedBox(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            color: const Color(0xff4b9ec1),
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0x33a5e5ff),
